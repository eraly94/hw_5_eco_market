...
import 'package:hw_5_eco_market/features/about/presentation/widgets/about_bottom_sheet.dart';
import 'package:hw_5_eco_market/features/about/presentation/widgets/social_button_widget.dart';
...
class _AboutPageState extends State<AboutPage> {
  ...
  _launchWhatsaPP() async {
    const url = 'https://wa.me/+996703011994';
  ...
  _launchInstagram() async {
    const url = 'https://instagram.com/madishov';
    // ignore: deprecated_member_use
    if (await canLaunch(url)) {
      // ignore: deprecated_member_use
      await launch(url);
